...
const PreparedPosts = ({ selectedItems, onBack, onContinue }: PreparedPostsProps) => {
  ...
  React.useEffect(() => {
    console.log('PreparedPosts received selectedItems:', selectedItems);
    const posts: PreparedPost[] = selectedItems.flatMap(item => {
      console.log(`Creating posts for ${item.name}, estimatedValue: ${item.estimatedValue}`);
      return [
        {
          id: `${item.id}-ebay`,
          item,
    ...
    <div className="w-full max-w-7xl mx-auto p-4 sm:p-6">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="text-center">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Prepared Listings</h1>
      ...
      <div className="mb-8">
        <div className="bg-white dark:bg-[#112233] rounded-2xl p-6 border border-gray-100 dark:border-[#1e3a52] shadow-sm">
          <div className="text-center">
            <h2 className="text-gray-900 dark:text-white text-xl font-semibold mb-2">Review Your Listings</h2>
            ...
            {preparedPosts.map((post, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Item Image */}
                  <div className="aspect-video bg-gray-50 dark:bg-[#0a1b2a] rounded-xl mb-4 flex items-center justify-center overflow-hidden">
                    <img
                  ...
                  <div className="space-y-3">
                    <h3 className="text-gray-900 dark:text-white font-semibold text-lg line-clamp-2">
                      {post.title}
                    </h3>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-gray-400 dark:text-gray-500 text-sm">Ready</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {post.tags.map((tag, idx) => (
                        <span
                          key={idx}
                          className="px-2 py-1 bg-gray-100 dark:bg-[#1e3a52] text-gray-600 dark:text-gray-300 text-xs rounded-full"
                        >
                          #{tag}
                        </span>
                      ))}
      ...
      {selectedPosts.size === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-gray-900 dark:text-white text-lg font-semibold mb-2">No listings selected</h3>
        ...
        {showDetailModal && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-[#112233] rounded-2xl p-6 max-w-2xl w-full border border-gray-100 dark:border-[#1e3a52] max-h-[80vh] overflow-y-auto shadow-2xl"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-gray-900 dark:text-white text-lg font-semibold">Listing Preview</h3>
                <button
                  onClick={() => setShowDetailModal(null)}
              ...
              {(() => {
                ...
                return (
                  <div className="space-y-4">
                    ...
                    <div className="aspect-video bg-gray-50 dark:bg-[#0a1b2a] rounded-xl overflow-hidden mb-4">
                      <img
                        src={post.item.croppedImageUrl}
                        alt={post.item.name}
                    ...
                    <div>
                      <h4 className="text-gray-900 dark:text-white font-semibold text-lg mb-2">{post.title}</h4>
                      ...
                      <div className="flex gap-2">
                        <motion.button
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                          className="flex-1 px-4 py-2 bg-gray-100 dark:bg-[#1e3a52] text-gray-700 dark:text-gray-200 text-sm rounded-lg hover:bg-gray-200 dark:hover:bg-[#2a4b66] transition-all flex items-center justify-center gap-2"
                        >
