...
export default function Home() {
  ...
  return (
    <div className="relative">
      {/* Navigation Bar */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-gray-200/50 dark:border-gray-800/50">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold">
                <span className="text-[#5BAAA7]">de</span>
                <span className="text-slate-900 dark:text-white">Cluttered</span>
                <span className="text-[#5BAAA7]">.ai</span>
              </h1>
            </div>
            <div className="hidden md:flex items-center space-x-8">
              <a href="#how-it-works" className="text-gray-700 hover:text-[#5BAAA7] font-medium transition-colors dark:text-gray-200">How It Works</a>
              <a href="#features" className="text-gray-700 hover:text-[#5BAAA7] font-medium transition-colors dark:text-gray-200">Features</a>
              <a href="#pricing" className="text-gray-700 hover:text-[#5BAAA7] font-medium transition-colors dark:text-gray-200">Pricing</a>
              <ThemeToggle />
              {user ? (
                <Link href="/dashboard" className="text-gray-700 hover:text-[#5BAAA7] font-medium transition-colors dark:text-gray-200">
                  Dashboard
                </Link>
              ) : (
                <Link href="/login" className="text-gray-700 hover:text-[#5BAAA7] font-medium transition-colors dark:text-gray-200">
                  Login
                </Link>
              )}
              <Link href="/dashboard">
