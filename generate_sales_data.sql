...
-- NOTE: This script has been updated to match the current schema.
-- The 'sales' table has been replaced by 'listings' with status='sold'.
...
DO $$
DECLARE
  target_user_id text := '34e345e8-210b-4c07-a9fc-febd8ef55ba3'; -- Your User ID
